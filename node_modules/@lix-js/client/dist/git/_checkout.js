import { STAGE, _GitRefManager, _readObject, _GitConfigManager, _flat, _walk, Errors, _GitIndexManager, _worthWalking, } from "../../vendored/isomorphic-git/index.js";
 ...
 *
 */
export async function _checkout({ fs, cache, onProgress, dir, gitdir, remote, ref, filepaths, noCheckout, noUpdateHead, dryRun, force, track = true, }) {
    // Get tree oid
    let oid;
    try {
                ...
                try {
                    if (method !== "create-index" && method !== "mkdir-index") {
                        ...
                        if (mode === 0o100644) {
                            ...
                            // @ts-ignore
                            throw new Errors.InternalError(`Invalid mode 0o${mode.toString(8)} detected in blob ${oid}`);
                        }
                    }
