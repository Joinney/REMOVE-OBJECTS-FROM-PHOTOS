import { walk, TREE, STAGE, writeTree, commit as isoGitCommit, } from "../../vendored/isomorphic-git/index.js";
import { getDirname, getBasename } from "@lix-js/fs";
export async function commit({ cache, fs, dir, ref, author, message, }) {
    const fileStates = {};
