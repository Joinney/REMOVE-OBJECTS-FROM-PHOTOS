import { n as normalPath, g as getDirname, a as getBasename } from "./index.js";
...
function createNodeishMemoryFs() {
  ...
  newStatEntry("/", state.fsStats, 1, 493);
  ...
  return {
    ...
    _createPlaceholder: async function(path, options) {
      ...
      const isSymbolicLink = (options == null ? void 0 : options.mode) === 12e4;
      newStatEntry(path, state.fsStats, isSymbolicLink ? 2 : 0, (options == null ? void 0 : options.mode) ?? 420);
    ...
    writeFile: async function(path, data, options) {
      ...
      parentDir.add(baseName);
      newStatEntry(path, state.fsStats, 0, (options == null ? void 0 : options.mode) ?? 420);
    ...
    mkdir: async function mkdir(path, options) {
      ...
      if (parentDir && parentDir instanceof Set) {
        ...
        parentDir.add(baseName);
        newStatEntry(path, state.fsStats, 1, 493);
    ...
    symlink: async function(target, path) {
      ...
      newStatEntry(path, state.fsStats, 2, 511, target);
    },
